...
@Component
public class BitbucketPageAPI {
    private final WebDriver driver;

    @FindBy(css = "input.paged-table-filter-input[placeholder='Filter repositories by name']")
    private WebElement campoPesquisarRepositorio;

    @FindBy(className = "paged-table")
    private WebElement tabelaResultados;

    public BitbucketPageAPI(WebDriver webDriver) {
